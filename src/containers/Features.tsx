  ...
  return (
    <div className="w-full m-auto flex flex-col justify-center items-center pb-[89px] pt-[72px] md:w-full">
      <div className="flex flex-col m-auto pr-[280px] lg:pr-[220px] md:pr-0 sm:pr-0 sm:text-2xl text-[44px] landing-[49px] text-left items-center">
        <p className="text-left w-[900px] sm:w-full md:w-full lg:w-full md:px-7 sm:px-7 lg:px-12">
      ...
      <section className="mt-[96px] sm:mt-10 pl-[313px] xxl:xxl:pl-[260px] xl:pl-[100px] lg:pl-12 md:pl-0 md: sm:pl-0 m-auto flex flex-col items-center justify-center md:flex-col">
